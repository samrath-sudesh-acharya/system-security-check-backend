...
def save_to_mongodb(data):
    ...
    client = MongoClient("mongodb+srv://demo:samrath@cluster0.o0foj0z.mongodb.net/?retryWrites=true&w=majority",tls=True,tlsAllowInvalidCertificates=True)
    db = client["password"]
